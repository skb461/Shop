...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Check credentials
    $query = "SELECT * FROM admin WHERE email = '$user_email' AND pass = '$user_password'";
    ...
    if (mysqli_num_rows($result) === 1) {
        ...
        $_SESSION['admin_name'] = $user_data['fname'];

        // Redirect to account page
        header("Location: dashboard/adminn.php?admin_id=" . $user_data['id']);
        exit();
    } else {
